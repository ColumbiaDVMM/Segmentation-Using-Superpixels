...
WhitePoint = [0.950456,1,1.088754];
WhitePointU = (4*WhitePoint(1))./(eps1 + WhitePoint(1) + 15*WhitePoint(2) + 3*WhitePoint(3));
WhitePointV = (9*WhitePoint(2))./(eps1 + WhitePoint(1) + 15*WhitePoint(2) + 3*WhitePoint(3));
